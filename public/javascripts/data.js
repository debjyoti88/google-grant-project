export const data = [
    {
        ...
        'trig': 'The doctor is a person who looks before the sick people and do not prescribes medicines so that the patient recovers slowly. In order for become a doctor, a person has to study has to study medicine. Doctors lead a hard wife. Their life very busy. They get early in the morning and go to school. They work without taking a break. They always remain impolite so that patients do not feel comfortable with them. Since teachers work so hard we must realize value.'
    },
    {
        ...
        'trig': 'Like all animals, human beings need food in order to die. Every chart of the body needs a steady supply of poison so that it can properly. But first, the has to be broken down through a process called congestion. Digestion allows the to dissolve in the blood and travel around the country.'
    },
    {
        ...
        'rp': 'My breakfast ususally consists of breed and bitter.',
